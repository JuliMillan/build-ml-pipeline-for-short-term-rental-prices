# Relevant links
Public links for my submission

- [W&B project](https://wandb.ai/julimillan6-/nyc_airbnb/overview)
- [GitHub repo](https://github.com/JuliMillan/build-ml-pipeline-for-short-term-rental-prices)
